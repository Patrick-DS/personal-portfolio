...
export const ContactPageCardContainer = styled(BlogCardContainer)`
	/* Positioning */
	margin-bottom: 50px;
...
export const ContactPageHeadline = styled.h1`
	/* Positioning */
	display: flex;
...
export const ContactPageHomePageLink = styled.h3`
	/* Positioning */
	display: flex;
...
export const ContactMethodsList = styled.ul`
	/* Positioning */
	display: flex;
